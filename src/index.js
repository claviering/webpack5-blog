...
let app = function (isLogin) {
  ...
  function updataQuestion(index, questionList) {
    let questionDomList = document.querySelectorAll('.question-content');
    let questionOptionDom = questionDomList[index].querySelector('.question-options');
    let optionList = '';
    ...
    questionOptionDom.innerHTML = optionList;
  }
  function initSelectEven(clickDomClass) {
    ...
    clickDom.onclick = function (e) {
      ...
      updataQuestion(index, questionList);
    }
  }
